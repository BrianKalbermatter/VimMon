...
- [ ] Reescribir `ParcialSimulado_01.paed` con `LEER`: hoy los valores siguen fijos en el codigo. Es el primer programa que se beneficia de la entrada, y sirve de prueba de que un parcial se resuelve como en la catedra #fase2
