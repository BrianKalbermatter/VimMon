...
#   echo "%devops ALL=(ALL) NOPASSWD: /usr/learnC/systemctl restart httpd" > /etc/sudoers.d/devops
#   chmod 440 /etc/sudoers.d/devops
#
# 20. Grupo dbadmins puede ejecutar comandos de postgres sin password
#   echo "%dbadmins ALL=(ALL) NOPASSWD: /usr/learnC/systemctl restart postgresql, /usr/learnC/systemctl status postgresql" > /etc/sudoers.d/dbadmins
